...
SIGNATURES: list[tuple[str, re.Pattern[str]]] = [
    ...
    ("gmail", re.compile(r"\.mbox$|takeout[/\\]mail|all mail including spam", re.I)),
    ("photos", re.compile(r"google photos|takeout[/\\]google photos|\.(jpg|jpeg|heic|png)\.json$", re.I)),
    ("maps", re.compile(r"location history|records\.json|semantic location|takeout[/\\]maps", re.I)),
    ("pay", re.compile(r"google pay|googlepay|google wallet|wallet[/\\]google", re.I)),
    ("search", re.compile(r"my activity[/\\]search|search[/\\]myactivity", re.I)),
    ("android_device", re.compile(r"androiddeviceconfigurationservice|deviceanduserprofile|android device configuration", re.I)),
    ("account", re.compile(r"googleaccount\.subscriberinfo|subscriberinfo|takeout[/\\]profile|profile\.json", re.I)),
    ("drive", re.compile(r"takeout[/\\]drive|google drive", re.I)),
    ("youtube", re.compile(r"youtube and youtube music|my activity[/\\]youtube", re.I)),
    ("chrome", re.compile(r"takeout[/\\]chrome", re.I)),
